...
setup(
  ...
  install_requires=['einops==0.8.1','igraph==0.10.8','numpy==2.2.6','opencv-python==4.10.0.84','Pillow==11.2.1','scanpy==1.11.2','scikit-image==0.25.2','scikit-learn==1.7.0','scipy==1.15.2','setuptools==75.8.2','torch==2.4.0','torchvision==0.19.0','tqdm==4.67.1'],
